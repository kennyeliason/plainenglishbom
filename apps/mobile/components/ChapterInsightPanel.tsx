...
import type { Chapter } from "@plainenglishbom/core";
import { chatAboutChapter } from "../lib/ai-client";
...
export function ChapterInsightPanel({
  chapter,
  bookName,
  chapterNum,
  onClose,
  ...
  // Generate storage key for this chapter
  const storageKey = `chat:${bookName}:${chapterNum}:chapter`;
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await chatAboutChapter(
        bookName,
        chapterNum,
        chapter,
        messages,
    ...
    <View style={styles.overlay}>
      ...
      >
        ...
        >
          ...
          {chapter.summary && (
            <ScrollView style={styles.summaryPreview} nestedScrollEnabled>
